...
<html lang="en-us">
  <head>
    <meta charset="UTF-8">
    <title>Fluorescent Proteins by sawsimeon</title>
  ...
  <body>
    <section class="page-header">
      <h1 class="project-name">Fluorescent Proteins</h1>
      <h2 class="project-tagline">Fluorescent Protein</h2>
      <a href="https://github.com/sawsimeon/OliFP" class="btn">View on GitHub</a>
      <a href="https://github.com/sawsimeon/OliFP/zipball/master" class="btn">Download .zip</a>
      <a href="https://github.com/sawsimeon/OliFP/tarball/master" class="btn">Download .tar.gz</a>
    </section>

    <section class="main-content">
      <h1>
<a id="bioluminescence" class="anchor" href="#bioluminescence" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Bioluminescence</h1>
